...
export function render(canvas, initialValue) {
  ...
  // 提供一个因此，来处理近大远小的效果
  // 只需要将坐标点的x,y值与z值联系起来，z越大，那么就将x,y值变得更小
  ...
  function updateFudgeFactor(value) {
    fudgeFactor = value
    drawScene()
  }
  ...
  function drawScene() {
    ...
    // )
    // 这里可以得到w的值，zin越大，w值就会越大；间接缩小了x,y的值
    // matrix = m4.multiply(makeZToWMatrix(fudgeFactor), matrix)
    /**
     * todo
     * =====================================================start===============================
     * 先乘以平移矩阵
